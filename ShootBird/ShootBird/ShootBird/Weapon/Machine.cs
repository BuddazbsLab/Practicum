...
{
    internal class Machine : IWeapon
    {
        ...
        public Machine(int startPlayEnemy, int? сartridge)
        {
            this.startPlayEnemy = startPlayEnemy;
            this.startDamageRange = 5;
            this.endDamageRange = 10;
        ...
        public async Task Shot()
        {
            ...
            for (int i = 0; i < Cartridge; i++)
            {
                ...
                Console.WriteLine($"Выстрел из автомата {i + 1}");
                Console.Beep();
